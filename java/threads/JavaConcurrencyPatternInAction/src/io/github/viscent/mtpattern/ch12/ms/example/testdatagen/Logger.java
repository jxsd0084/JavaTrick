...
package threads.JavaConcurrencyPatternInAction.src.io.github.viscent.mtpattern.ch12.ms.example.testdatagen;
...
public class Logger {
	...
	// 接口日志输出目标目录
	private static final String LOG_FILE_BASE_DIR  = System.getProperty( "java.io.tmpdir" ) + "/tps/";
