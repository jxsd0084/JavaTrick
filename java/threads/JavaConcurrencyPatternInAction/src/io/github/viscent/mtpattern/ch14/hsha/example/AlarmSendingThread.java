...
import threads.JavaConcurrencyPatternInAction.src.io.github.viscent.mtpattern.ch5.tpt.example.AlarmType;
	...
	*/
	...
	public int sendAlarm( final AlarmInfo alarmInfo ) {
		...
		try {
			...
			prevSubmittedCounter = submittedAlarmRegistry.putIfAbsent( type.toString() + ':' + id + '@' +
			                                                           extraInfo, new AtomicInteger( 0 ) );
