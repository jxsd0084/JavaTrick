...
package threads.JavaConcurrencyPatternInAction.src.io.github.viscent.mtpattern.ch13.pipeline.example;

import threads.JavaConcurrencyPatternInAction.src.io.github.viscent.mtpattern.ch13.pipeline.AbstractPipe;
import threads.JavaConcurrencyPatternInAction.src.io.github.viscent.mtpattern.ch13.pipeline.Pipe;
import threads.JavaConcurrencyPatternInAction.src.io.github.viscent.mtpattern.ch13.pipeline.PipeException;
import threads.JavaConcurrencyPatternInAction.src.io.github.viscent.mtpattern.ch13.pipeline.SimplePipeline;
...
public class ThreadPoolBasedPipeExample {
	...
	public static void main( String[] args ) {
		...
		executorSerivce = new ThreadPoolExecutor( 1,
				Runtime.getRuntime().availableProcessors() * 2, 60, TimeUnit.MINUTES,
