...
package threads.JavaConcurrencyPatternInAction.src.io.github.viscent.mtpattern.ch14.hsha;
...
public abstract class AsyncTask < V > {
	...
	static {
		...
		DEFAULT_EXECUTOR = new ThreadPoolExecutor( 1, 1, 8,
				TimeUnit.HOURS, new LinkedBlockingQueue< Runnable >(), new ThreadFactory() {
