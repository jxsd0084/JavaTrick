package threads.JavaThreadCookBook.ch09_线程的监控及其日常工作中如何分析._1_Java线程池的监控;
...
class MonitorThreadPoolExecutor extends ThreadPoolExecutor {
	...
	protected void terminated() {
		...
		System.out.println( "terminated getCorePoolSize:" +
		                    this.getCorePoolSize() + "；getPoolSize:" +
		                    this.getPoolSize() + "；getTaskCount:" +
		                    this.getTaskCount() + "；getCompletedTaskCount:" +
