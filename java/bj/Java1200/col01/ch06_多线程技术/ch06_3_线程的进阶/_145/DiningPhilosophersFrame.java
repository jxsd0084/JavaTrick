...
public class DiningPhilosophersFrame extends JFrame {
	...
	public DiningPhilosophersFrame() {
		...
		thinkingLabel.setFont( new Font( "微软雅黑", Font.PLAIN, 14 ) );
		...
		thinkingTextArea.setFont( new Font( "微软雅黑", Font.PLAIN, 12 ) );
		...
		eatingLabel.setFont( new Font( "微软雅黑", Font.PLAIN, 14 ) );
		...
		eatingTextArea.setFont( new Font( "微软雅黑", Font.PLAIN, 12 ) );
		...
		waitingLabel.setFont( new Font( "微软雅黑", Font.PLAIN, 14 ) );
		...
		waitingTextArea.setFont( new Font( "微软雅黑", Font.PLAIN, 12 ) );
