package bj.Java1200.col01.ch20_操作办公文档.ch20_2_操作Excel._484;
	...
	public void excelToHtml( String xlsfilePath, String htmlfilePath ) {
		...
		try {
			...
			Dispatch excel = Dispatch.invoke(
					...
					Dispatch.Method,
					new Object[]{
							xlsfilePath, new Variant( false ),
							new Variant( true )
					}, new int[ 1 ] ).toDispatch(); // 功能调用
			Dispatch.invoke( excel, "SaveAs", Dispatch.Method, new Object[]{
					htmlfilePath, new Variant( 44 )
			}, new int[ 1 ] ); // 以html格式保存到临时文件
