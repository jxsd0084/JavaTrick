package bj.Java1200.col01.ch09_编程常用类.ch09_1_Calendar类的使用._192_简单的电子时钟;
...
public class ElectronicClock extends JFrame {
	...
	private ImageIcon[] numbers = {
			new ImageIcon( "src/images/0.png" ), new ImageIcon( "src/images/1.png" ), new ImageIcon( "src/images/2.png" ), new ImageIcon( "src/images/3.png" ),
