...
public class GBC extends GridBagConstraints {
	...
	public GBC setInsetsOfX( int distance, bj.powernode.basic.day21.employees_mgt_sys.basic.Insets x ) {

		if ( x == bj.powernode.basic.day21.employees_mgt_sys.basic.Insets.TOP ) {
			this.insets.top = distance;
		} else if ( x == bj.powernode.basic.day21.employees_mgt_sys.basic.Insets.BOTTOM ) {
			this.insets.bottom = distance;
		} else if ( x == bj.powernode.basic.day21.employees_mgt_sys.basic.Insets.LEFT ) {
			this.insets.left = distance;
		} else if ( x == bj.powernode.basic.day21.employees_mgt_sys.basic.Insets.RIGHT ) {
