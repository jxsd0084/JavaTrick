...
import bj.powernode.basic.day26.EMS.entity.Job;
import bj.powernode.basic.day26.EMS.service.EmployeeService;
import bj.powernode.basic.day26.EMS.service.JobService;
...
public class EntryEInfoPage extends JFrame {
	...
	class CommitButtonActionListener implements ActionListener {
		...
		public void actionPerformed( ActionEvent e ) {
			...
			String  ename    = enameTextField.getText();
			boolean sex      = maleRadioButton.isSelected() ? true : false;
			...
			if ( "修改".equals( cmd ) ) {
				operator = "修改";
				isSuccess = es.modify( employee );
			}
			if ( "提交".equals( cmd ) ) {
				operator = "录入";
				isSuccess = es.save( employee );
			}


			//4.如果持久化成功,提醒
			if ( isSuccess ) {
				JOptionPane.showMessageDialog( EntryEInfoPage.this, operator + "员工信息成功", operator + "成功", JOptionPane.INFORMATION_MESSAGE );
				EntryEInfoPage.this.removeNotify(); //关闭窗口
			} else {
				//5.如果持久化失败,提醒
				JOptionPane.showMessageDialog( EntryEInfoPage.this, operator + "员工信息失败", operator + "失败", JOptionPane.ERROR_MESSAGE );
			}
		}
	...
	public JComboBox getYearBox1() {

		return yearBox1;
	}


	public void setYearBox1( JComboBox yearBox1 ) {

		this.yearBox1 = yearBox1;
	}


	public JComboBox getMonthBox1() {

		return monthBox1;
	}


	public void setMonthBox1( JComboBox monthBox1 ) {

		this.monthBox1 = monthBox1;
	}


	public JComboBox getDayBox1() {

		return dayBox1;
	}


	public void setDayBox1( JComboBox dayBox1 ) {

		this.dayBox1 = dayBox1;
	}


	public JComboBox getEjobBox() {

		return ejobBox;
	}


	public void setEjobBox( JComboBox ejobBox ) {

		this.ejobBox = ejobBox;
	}


	public JTextField getEsalTextField() {

		return esalTextField;
	}


	public void setEsalTextField( JTextField esalTextField ) {

		this.esalTextField = esalTextField;
	}


	public JTextField geteTelTextField() {

		return eTelTextField;
	}


	public void seteTelTextField( JTextField eTelTextField ) {

		this.eTelTextField = eTelTextField;
	}
	...
	public JComboBox getEgradeBox() {

		return egradeBox;
	}


	public void setEgradeBox( JComboBox egradeBox ) {

		this.egradeBox = egradeBox;
	}
	...
	public JCheckBox getSs01CheckBox() {

		return ss01CheckBox;
	}


	public void setSs01CheckBox( JCheckBox ss01CheckBox ) {

		this.ss01CheckBox = ss01CheckBox;
	}


	public JCheckBox getSs02CheckBox() {

		return ss02CheckBox;
	}


	public void setSs02CheckBox( JCheckBox ss02CheckBox ) {

		this.ss02CheckBox = ss02CheckBox;
	}


	public JCheckBox getSs03CheckBox() {

		return ss03CheckBox;
	}


	public void setSs03CheckBox( JCheckBox ss03CheckBox ) {

		this.ss03CheckBox = ss03CheckBox;
	}


	public JCheckBox getSs04CheckBox() {

		return ss04CheckBox;
	}


	public void setSs04CheckBox( JCheckBox ss04CheckBox ) {

		this.ss04CheckBox = ss04CheckBox;
	}


	public JCheckBox getSs05CheckBox() {

		return ss05CheckBox;
	}


	public void setSs05CheckBox( JCheckBox ss05CheckBox ) {

		this.ss05CheckBox = ss05CheckBox;
	}


	public JCheckBox getSs06CheckBox() {

		return ss06CheckBox;
	}


	public void setSs06CheckBox( JCheckBox ss06CheckBox ) {

		this.ss06CheckBox = ss06CheckBox;
	}
	...
	public void setEntryButton( JButton entryButton ) {
	...
	public JLabel getEchoEnoLabel() {

		return echoEnoLabel;
	}


	public void setEchoEnoLabel( JLabel echoEnoLabel ) {

		this.echoEnoLabel = echoEnoLabel;
	}
