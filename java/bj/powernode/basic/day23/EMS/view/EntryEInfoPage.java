package bj.powernode.basic.day23.EMS.view;
...
public class EntryEInfoPage extends JFrame {
	...
	private JTextField   enoTextField; //员工编号文本框
	private JLabel       currentEnoLabel; //当前员工编号的Label
	...
	private EntryEInfoPage() {
		...
		enoTextField = new JTextField( 15 );
		currentEnoLabel = new JLabel( "当前员工编号0500" );
		...
		mainPanel.add( enoTextField, new GBC( 0, 0, 1, 1, 100, 100 ).setAnchor( GBC.WEST ).setInsets( 80, Orientation.LEFT ) );
		mainPanel.add( currentEnoLabel, new GBC( 0, 0, 1, 1, 100, 100 ).setAnchor( GBC.WEST ).setInsets( 260, Orientation.LEFT ) );
