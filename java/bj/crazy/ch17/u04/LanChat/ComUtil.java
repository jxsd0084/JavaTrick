package bj.crazy.ch17.u04.LanChat;
		...
		public void run() {
			...
			while ( true ) {
				...
				// 捕捉异常
					...
					JOptionPane.showMessageDialog( null, "接收信息异常，请确认30001端口空闲，且网络连接正常！"
							, "网络异常", JOptionPane.ERROR_MESSAGE );
					System.exit( 1 );
				}
			}
		...
		public void run() {
			...
			while ( true ) {
				...
				// 捕捉异常
					...
					JOptionPane.showMessageDialog( null, "接收信息异常，请确认30000端口空闲，且网络连接正常！"
							, "网络异常", JOptionPane.ERROR_MESSAGE );
					System.exit( 1 );
				}
