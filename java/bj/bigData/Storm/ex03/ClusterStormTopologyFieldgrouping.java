...
public class ClusterStormTopologyFieldgrouping {
	...
	public static void main( String[] args ) {
		...
		topologyBuilder.setBolt( "bolt_id", new Sumbolt() ).fieldsGrouping( "spout_id", new Fields( "flag" ) );
		
		
		String simpleName = ClusterStormTopologyFieldgrouping.class.getSimpleName();
		try {
