package bj.bigData.Hadoop.Hadoop_260.ex01.topK;

import bj.bigData.Hadoop.Hadoop_260.ex01.wc.WordCountApp;
...
public class TopKApp {
	...
	static class MyReducer extends Reducer< LongWritable, NullWritable, LongWritable, NullWritable > {
		...
		protected void reduce( LongWritable k2, Iterable< NullWritable > arg1, Context arg2 ) throws java.io.IOException, InterruptedException {
