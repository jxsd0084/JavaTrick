...
public class MonitorIpinfoCreater extends BaseCreater {
	...
	public byte[][] buildRegionRange( String tableName ) {
		...
		int      sprangsize = Integer.parseInt( prop.getProperty( "table.monitoripinfo.region.size" ) );
		int      keylength  = Integer.parseInt( prop.getProperty( "table.monitoripinfo.key.length" ) );
	...
	public String getTable( String date ) throws ParseException {
		...
		String table = prop.getProperty( "table.monitoripinfo.name" );
