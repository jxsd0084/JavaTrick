...
public class FilterLogsCreater extends BaseCreater {
	...
	//	//按天分表后，因为时间再第一个字段，因此key的范围要特殊设置
//	@Override
//	public byte[][] buildRegionRange(String tableName) {
//		int sprangsize = Integer.parseInt(prop.getProperty("table.filterlogs.region.size"));
//		int keylength = Integer.parseInt(prop.getProperty("table.filterlogs.key.length"));	
//		
...
//	}
	...
	public String getTable( String date ) throws ParseException {
		...
		String table = prop.getProperty( "table.filterlogs.name" );
...
//		FilterLogsCreater c = new FilterLogsCreater();
//		byte[][] bs = c.buildRegionRange("TO_NET_ODS_ILLEGALINFO_20130723");
//		for(byte[] b:bs){
