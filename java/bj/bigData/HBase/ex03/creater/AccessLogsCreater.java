...
public class AccessLogsCreater extends BaseCreater {
	...
	public byte[][] buildRegionRange( String tableName ) {
		...
		int      sprangsize = Integer.parseInt( prop.getProperty( "table.accesslogs.region.size" ) );
		int      keylength  = Integer.parseInt( prop.getProperty( "table.accesslogs.key.length" ) );
	...
	public String getTable( String date ) throws ParseException {
		...
		String table = prop.getProperty( "table.accesslogs.name" );
