...
public class MonitorIpInfoScanner extends BaseScanner implements Runnable {

	Logger logger = Logger.getLogger( MonitorIpInfoScanner.class );
	private static final TableInfo tableInfo  = IdcTableInfos.getTableInfo( TableConstants.TO_NET_ODS_MONITOR_IPINFO );
	//key length
	private static final int       KEY_LENGTH = TableConstants.TABLE_MONITOR_IPINFO_KEY_LENGTH;
	private int pageNo;
	...
	public MonitorIpInfoScanner( Session session, TCommonCondition tcc,
